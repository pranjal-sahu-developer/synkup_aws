...
const NotificationsPage = () => {
  ...
  const { unreadChannels } = useNotificationCount();
            ...
            {unreadChannels.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  New Messages
                  <span className="badge badge-primary ml-2">{unreadChannels.length}</span>
                </h2>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              {channel.lastMessage && (
                                <p className="text-sm opacity-70 mt-1 truncate max-w-md">
                                  {channel.lastMessage.text || "Sent an attachment"}
                                </p>
                              )}
                            </div>
                          </div>
                          <div className="badge badge-error">
                            {channel.unreadCount} {channel.unreadCount === 1 ? "message" : "messages"}
                          </div>
                        </div>
                      </div>
                    </Link>
